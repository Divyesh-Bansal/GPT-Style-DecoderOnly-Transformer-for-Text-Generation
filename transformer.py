...
#Define hyperparameters - These are the hyperparameters that have given the best result yet
...
#Download dataset
!wget 'https://raw.githubusercontent.com/karpathy/char-rnn/master/data/tinyshakespeare/input.txt' -O shakespeare_input.txt
...
#When the model was trained, there was an embedding layer in the Decoder class instead of the Transformer class, which has been changed since then. In order for the model to work, 2 of the keys need to be renamed. 
